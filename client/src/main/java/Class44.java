...
public final class Class44 {
	...
	public int[] method576(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		for (@Pc(3) int local3 = 0; local3 < arg0; local3++) {
			Static34.anIntArray239[local3] = 0;
		}
		if (arg1 < 10) {
			return Static34.anIntArray239;
		}
		@Pc(26) double local26 = (double) arg0 / ((double) arg1 + 0.0D);
		this.aClass42_1.method553(Static34.anInt943);
		this.aClass42_2.method553(Static34.anInt943);
		@Pc(36) int local36 = 0;
		@Pc(38) int local38 = 0;
		@Pc(40) int local40 = 0;
		if (this.aClass42_3 != null) {
			this.aClass42_3.method553(Static34.anInt943);
			this.aClass42_4.method553(Static34.anInt943);
		...
		if (this.aClass42_5 != null) {
			this.aClass42_5.method553(Static34.anInt943);
			this.aClass42_6.method553(Static34.anInt943);
		...
		for (@Pc(118) int local118 = 0; local118 < 5; local118++) {
			if (this.anIntArray236[local118] != 0) {
				Static34.anIntArray242[local118] = 0;
				Static34.anIntArray243[local118] = (int) ((double) this.anIntArray238[local118] * local26);
				Static34.anIntArray244[local118] = (this.anIntArray236[local118] << 14) / 100;
				Static34.anIntArray245[local118] = (int) ((double) (this.aClass42_1.anInt820 - this.aClass42_1.anInt819) * 32.768D * Math.pow(1.0057929410678534D, (double) this.anIntArray237[local118]) / local26);
				Static34.anIntArray246[local118] = (int) ((double) this.aClass42_1.anInt819 * 32.768D / local26);
			}
		}
		@Pc(201) int local201;
		@Pc(207) int local207;
		...
		for (@Pc(193) int local193 = 0; local193 < arg0; local193++) {
			...
			for (local216 = 0; local216 < 5; local216++) {
				if (this.anIntArray236[local216] != 0) {
					local222 = local193 + Static34.anIntArray243[local216];
					if (local222 < arg0) {
						Static34.anIntArray239[local222] += this.method577(-15143, local207 * Static34.anIntArray244[local216] >> 15, Static34.anIntArray242[local216], this.aClass42_1.anInt821);
						Static34.anIntArray242[local216] += (local201 * Static34.anIntArray245[local216] >> 16) + Static34.anIntArray246[local216];
					}
				}
			}
		}
		if (this.aClass42_7 != null) {
			this.aClass42_7.method553(Static34.anInt943);
			this.aClass42_8.method553(Static34.anInt943);
			local201 = 0;
			...
			for (local222 = 0; local222 < arg0; local222++) {
				...
				if (local369) {
					Static34.anIntArray239[local222] = 0;
				}
			}
		}
		if (this.anInt945 > 0 && this.anInt946 > 0) {
			...
			for (local207 = local201; local207 < arg0; local207++) {
				Static34.anIntArray239[local207] += Static34.anIntArray239[local207 - local201] * this.anInt946 / 100;
			}
		}
		for (local201 = 0; local201 < arg0; local201++) {
			if (Static34.anIntArray239[local201] < -32768) {
				Static34.anIntArray239[local201] = -32768;
			}
			if (Static34.anIntArray239[local201] > 32767) {
				Static34.anIntArray239[local201] = 32767;
			}
		}
		return Static34.anIntArray239;
	}
	...
	private int method577(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3) {
		try {
			if (arg0 != this.anInt944) {
				...
				return Static34.anIntArray241[arg2 & 0x7FFF] * arg1 >> 14;
			} else if (arg3 == 3) {
				return ((arg2 & 0x7FFF) * arg1 >> 14) - arg1;
			} else if (arg3 == 4) {
				return Static34.anIntArray240[arg2 / 2607 & 0x7FFF] * arg1;
			} else {
				return 0;
			}
	...
	public void method578(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class1_Sub3_Sub3 arg1) {
		try {
