...
public final class Static24 {
	...
	public static void method414(@OriginalArg(0) Class39 arg0) {
		@Pc(11) Class1_Sub3_Sub3 local11 = new Class1_Sub3_Sub3(363, arg0.method536("fragmentsenc.txt", null, (byte) 2));
		@Pc(21) Class1_Sub3_Sub3 local21 = new Class1_Sub3_Sub3(363, arg0.method536("badenc.txt", null, (byte) 2));
		@Pc(31) Class1_Sub3_Sub3 local31 = new Class1_Sub3_Sub3(363, arg0.method536("domainenc.txt", null, (byte) 2));
		@Pc(41) Class1_Sub3_Sub3 local41 = new Class1_Sub3_Sub3(363, arg0.method536("tldlist.txt", null, (byte) 2));
	...
	private static void method416(@OriginalArg(0) boolean arg0, @OriginalArg(1) Class1_Sub3_Sub3 arg1) {
		try {
	...
	private static void method418(@OriginalArg(0) Class1_Sub3_Sub3 arg0, @OriginalArg(1) int arg1) {
		try {
	...
	private static void method419(@OriginalArg(0) int arg0, @OriginalArg(1) Class1_Sub3_Sub3 arg1) {
		try {
	...
	private static void method420(@OriginalArg(0) byte[][][] arg0, @OriginalArg(1) char[][] arg1, @OriginalArg(2) Class1_Sub3_Sub3 arg2, @OriginalArg(3) byte arg3) {
		try {
			if (arg3 == 1) {
	...
	private static void method421(@OriginalArg(0) int arg0, @OriginalArg(1) Class1_Sub3_Sub3 arg1, @OriginalArg(2) char[][] arg2) {
		try {
			label35: while (true) {
				@Pc(5) int local5;
				if (arg0 >= 0) {
