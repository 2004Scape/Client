...
public final class IfType {
	...
	public static void unpack(@OriginalArg(0) Jagfile arg0, @OriginalArg(1) PixFont[] arg1, @OriginalArg(3) Jagfile arg3) {
		imageCache = new LruCache(50000);
		modelCache = new LruCache(50000);
		@Pc(27) Packet local27 = new Packet(arg3.read("data", null));
		@Pc(29) int local29 = -1;
