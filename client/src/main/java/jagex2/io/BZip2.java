...
public final class BZip2 {
	...
	private static void finish(@OriginalArg(0) BZip2State arg0) {
		...
		@Pc(15) int[] local15 = BZip2State.tt;
	...
	private static void decompress(@OriginalArg(0) BZip2State arg0) {
		...
		while (local60) {
			...
			local64 = getUnsignedChar(arg0);
			local64 = getBit(arg0);
			arg0.blockRandomized = local64 != 0;
			...
			for (local164 = 0; local164 < 16; local164++) {
				local64 = getBit(arg0);
				arg0.inUse16[local164] = local64 == 1;
			}
	...
	private static byte getUnsignedChar(@OriginalArg(0) BZip2State arg0) {
		return (byte) getBits(8, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "d", descriptor = "(Lclient!sb;)B")
	private static byte getBit(@OriginalArg(0) BZip2State arg0) {
		return (byte) getBits(1, arg0);
	}

	@OriginalMember(owner = "client!rb", name = "a", descriptor = "(ILclient!sb;)I")
	private static int getBits(@OriginalArg(0) int arg0, @OriginalArg(1) BZip2State arg1) {
	...
	private static void makeMaps(@OriginalArg(0) BZip2State arg0) {
		arg0.nInUse = 0;
