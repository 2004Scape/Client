		...
		try {
			...
			if (arg2 == 59 || arg2 == 76) {
				...
				if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
					...
					for (@Pc(74) LocTemporary local74 = (LocTemporary) this.spawnedLocations.peekFront(); local74 != null; local74 = (LocTemporary) this.spawnedLocations.prev(551)) {
				...
				if (arg2 == 223) {
					...
					if (arg2 == 69) {
						...
						if (arg2 == 23) {
							...
							if (local921 != null) {
								@Pc(946) LocSpawned local946 = new LocSpawned(this.currentLevel, local42, local31, local572 + loopCycle, 2, local38, -1, local24, local47);
								this.temporaryLocs.pushBack(local946);
								@Pc(966) LocSpawned local966 = new LocSpawned(this.currentLevel, local42, local31, local575 + loopCycle, 2, local38, local52, local24, local47);
	...
	private void updateTemporaryLocs(@OriginalArg(0) int arg0) {
		try {
			...
			if (this.sceneState == 2) {
				for (@Pc(12) LocSpawned local12 = (LocSpawned) this.temporaryLocs.peekFront(); local12 != null; local12 = (LocSpawned) this.temporaryLocs.prev(551)) {
	...
	private void buildScene(@OriginalArg(0) int arg0) {
		try {
			try {
				...
				for (@Pc(361) LocTemporary local361 = (LocTemporary) this.spawnedLocations.peekFront(); local361 != null; local361 = (LocTemporary) this.spawnedLocations.prev(551)) {
		...
		try {
			...
			try {
				...
				if (this.packetType == 237) {
					...
					for (@Pc(1066) LocTemporary local1066 = (LocTemporary) this.spawnedLocations.peekFront(); local1066 != null; local1066 = (LocTemporary) this.spawnedLocations.prev(551)) {
				...
				if (this.packetType == 135) {
					...
					for (@Pc(2487) LocTemporary local2487 = (LocTemporary) this.spawnedLocations.peekFront(); local2487 != null; local2487 = (LocTemporary) this.spawnedLocations.prev(551)) {
