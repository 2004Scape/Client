...
public final class Pix24 extends Draw2D {
	...
	public void crop(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(4) int arg4) {
		try {
			...
			this.scale(local11, local37, Draw2D.data, local43, local13, this.pixels, local141, local137, arg0, local6, arg2);
	...
	private void scale(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int[] arg2, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(7) int[] arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10, @OriginalArg(11) int arg11, @OriginalArg(12) int arg12) {
		@Pc(5) int local5;
		try {
			local5 = arg0;
	...
	public void draw(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		...
		if (local33 > 0 && local30 > 0) {
			this.copyPixelsAlpha(local4, this.pixels, arg0, local30, Draw2D.data, local27, local33, local37, local39);
		}
	}

	@OriginalMember(owner = "client!hb", name = "a", descriptor = "(II[III[IIBIII)V")
	private void copyPixelsAlpha(@OriginalArg(0) int arg0, @OriginalArg(2) int[] arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[] arg5, @OriginalArg(6) int arg6, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) int arg10) {
