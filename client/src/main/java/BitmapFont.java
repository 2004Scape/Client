...
public final class BitmapFont extends Draw2D {
	...
	public BitmapFont(@OriginalArg(0) FileArchive arg0, @OriginalArg(1) String arg1, @OriginalArg(2) int arg2) {
		try {
			@Pc(71) Buffer local71 = new Buffer(363, arg0.method536(arg1 + ".dat", null, (byte) 2));
			@Pc(81) Buffer local81 = new Buffer(363, arg0.method536("index.dat", null, (byte) 2));
			local81.position = local71.method393() + 4;
			@Pc(90) int local90 = local81.method391();
			if (local90 > 0) {
				local81.position += (local90 - 1) * 3;
			}
			@Pc(131) int local131;
	...
	private void method370(@OriginalArg(0) byte[] arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5) {
		...
		if (arg3 > 0 && arg4 > 0) {
			this.method371(Draw2D.anIntArray178, arg0, arg5, local13, local5, arg3, arg4, local9, local11);
		}
	}
	...
	private void method372(@OriginalArg(0) byte[] arg0, @OriginalArg(1) byte arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7) {
		try {
			if (arg1 == this.flowObfuscator3) {
				...
				if (arg7 > 0 && arg3 > 0) {
					this.method373(arg3, local10, arg7, Draw2D.anIntArray178, arg0, arg6, local18, local14, local16, (byte) 2, arg4);
				}
			}
		} catch (@Pc(132) RuntimeException local132) {
