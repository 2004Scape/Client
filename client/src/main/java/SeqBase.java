...
public final class SeqBase {
	...
	public static void method261(@OriginalArg(0) boolean arg0, @OriginalArg(1) FileArchive arg1) {
		try {
			@Pc(11) Buffer local11 = new Buffer(363, arg1.method536("base_head.dat", null, (byte) 2));
			@Pc(21) Buffer local21 = new Buffer(363, arg1.method536("base_type.dat", null, (byte) 2));
			@Pc(31) Buffer local31 = new Buffer(363, arg1.method536("base_label.dat", null, (byte) 2));
