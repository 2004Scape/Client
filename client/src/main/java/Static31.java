...
public final class Static31 {
	...
	public static String method545(@OriginalArg(0) Class1_Sub3_Sub3 arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2) {
		try {
			@Pc(3) int local3 = 0;
			@Pc(5) int local5 = -1;
			@Pc(9) int local9 = 43 / arg1;
			@Pc(22) int local22;
	...
	public static void method546(@OriginalArg(0) Class1_Sub3_Sub3 arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) String arg2) {
		try {
			if (arg2.length() > 80) {
			...
			signlink.reporterror("98255, " + arg0 + ", " + arg1 + ", " + arg2 + ", " + local107.toString());
			throw new RuntimeException();
		}
	}
}
