...
public class ObjType {
	...
	public static Pix32 getIcon(@OriginalArg(0) int id, @OriginalArg(2) int count) {
		...
		@Pc(88) int _l = Pix2D.left;
		@Pc(90) int _r = Pix2D.right;
		@Pc(92) int _t = Pix2D.top;
		@Pc(94) int _b = Pix2D.bottom;
		...
		@Pc(125) int sinPitch = Pix3D.sin[obj.xan2d] * obj.zoom2d >> 16;
		@Pc(135) int cosPitch = Pix3D.cos[obj.xan2d] * obj.zoom2d >> 16;
