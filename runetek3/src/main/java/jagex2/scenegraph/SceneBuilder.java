...
import jagex2.scenegraph.entity.LocEntity;
...
public final class SceneBuilder {
	...
	public static void addLoc(@OriginalArg(0) int arg0, @OriginalArg(1) linkablelist arg1, @OriginalArg(2) CollisionMap arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int[][][] arg5, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9, @OriginalArg(10) Scene arg10, @OriginalArg(11) int arg11) {
	...
	public void readLocs(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Scene arg1, @OriginalArg(2) CollisionMap[] arg2, @OriginalArg(3) linkablelist arg3, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(7) packet local7 = new packet(arg0);
		@Pc(19) int local19 = -1;
		while (true) {
	...
	private void addLoc(@OriginalArg(0) CollisionMap arg0, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Scene arg6, @OriginalArg(7) linkablelist arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		if (lowMemory) {
						...
						for (tileX = 0; tileX <= this.maxTileX; tileX++) {
							...
							if ((this.levelOccludemap[level][tileX][tileZ] & wall0) != 0) {
								...
								if (local204 >= OCCLUDER_THRESHOLD) {
									...
									Scene.addOccluder(local145 * 128 + 128, tileX * 128, local220, 1, tileX * 128, topLevel, local214, local141 * 128);
							...
							if ((this.levelOccludemap[level][tileX][tileZ] & wall1) != 0) {
								...
								if (local204 >= OCCLUDER_THRESHOLD) {
									...
									Scene.addOccluder(tileZ * 128, local141 * 128, local220, 2, local145 * 128 + 128, topLevel, local214, tileZ * 128);
									for (local236 = local169; local236 <= local191; local236++) {
										for (local284 = local141; local284 <= local145; local284++) {
							...
							if ((this.levelOccludemap[level][tileX][tileZ] & wall2) != 0) {
								...
								if ((local145 + 1 - local141) * (local191 + 1 - local169) >= 4) {
									...
									Scene.addOccluder(local191 * 128 + 128, local141 * 128, local204, 4, local145 * 128 + 128, topLevel, local204, local169 * 128);
