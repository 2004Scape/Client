...
public final class packet extends cacheable {
	...
	public static final linkablelist cacheMin = new linkablelist();

	@OriginalMember(owner = "client!kb", name = "A", descriptor = "Lclient!ob;")
	public static final linkablelist cacheMid = new linkablelist();

	@OriginalMember(owner = "client!kb", name = "B", descriptor = "Lclient!ob;")
	public static final linkablelist cacheMax = new linkablelist();
