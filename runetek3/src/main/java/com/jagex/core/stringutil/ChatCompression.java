...
public final class ChatCompression {
	...
	public static String unpack(@OriginalArg(0) Buffer arg0, @OriginalArg(2) int arg2) {
		@Pc(3) int local3 = 0;
		@Pc(5) int local5 = -1;
		@Pc(22) int local22;
	...
	public static void pack(@OriginalArg(0) Buffer arg0, @OriginalArg(2) String arg2) {
		if (arg2.length() > 80) {
