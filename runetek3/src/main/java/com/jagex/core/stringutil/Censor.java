package com.jagex.core.stringutil;
...
public final class Censor {
	...
	private static void readTld(@OriginalArg(1) Buffer arg1) {
	...
	private static void readBadWords(@OriginalArg(1) Buffer arg1) {
	...
	private static void readDomains(@OriginalArg(0) Buffer arg0) {
	...
	private static void readFragments(@OriginalArg(1) Buffer arg1) {
	...
	private static void readBadCombinations(@OriginalArg(0) byte[][][] arg0, @OriginalArg(1) char[][] arg1, @OriginalArg(2) Buffer arg2) {
	...
	private static void readDomain(@OriginalArg(1) Buffer arg1, @OriginalArg(2) char[][] arg2) {
