...
public final class Buffer extends CacheableNode {
	...
	public static final DoublyLinkedList cacheMin = new DoublyLinkedList();

	@OriginalMember(owner = "client!kb", name = "A", descriptor = "Lclient!ob;")
	public static final DoublyLinkedList cacheMid = new DoublyLinkedList();

	@OriginalMember(owner = "client!kb", name = "B", descriptor = "Lclient!ob;")
	public static final DoublyLinkedList cacheMax = new DoublyLinkedList();
	...
	public Buffer(@OriginalArg(1) byte[] arg1) {
		this.data = arg1;
		this.pos = 0;
	}

	@OriginalMember(owner = "client!kb", name = "a", descriptor = "(II)Lclient!kb;")
	public static Buffer alloc(@OriginalArg(0) int arg0) {
		...
		@Pc(77) Buffer local77 = new Buffer();
		local77.pos = 0;
		if (arg0 == 0) {
