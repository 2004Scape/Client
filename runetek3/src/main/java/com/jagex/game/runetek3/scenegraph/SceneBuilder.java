...
public final class SceneBuilder {
	...
	public void readLocs(@OriginalArg(0) byte[] arg0, @OriginalArg(1) Scene arg1, @OriginalArg(2) CollisionMap[] arg2, @OriginalArg(3) DoublyLinkedList arg3, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6) {
		@Pc(7) Buffer local7 = new Buffer(arg0);
		@Pc(19) int local19 = -1;
		while (true) {
	...
	private void addLoc(@OriginalArg(0) CollisionMap arg0, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) Scene arg6, @OriginalArg(7) DoublyLinkedList arg7, @OriginalArg(8) int arg8, @OriginalArg(9) int arg9) {
		if (lowMemory) {
