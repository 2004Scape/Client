...
import jagex2.datastruct.linkablelist;
import jagex2.graphics.*;
import jagex2.io.*;
import jagex2.scenegraph.*;
import jagex2.scenegraph.entity.*;
...
public final class client extends gameshell {
	...
	private linkablelist locList = new linkablelist();
	...
	private linkablelist temporaryLocs = new linkablelist();
	...
	private jagex2.graphics.Image24[] imageHitmarks = new jagex2.graphics.Image24[20];
	...
	private jagex2.graphics.Image24[] activeMapFunctions = new jagex2.graphics.Image24[1000];
	...
	private linkablelist projectiles = new linkablelist();
	...
	private jagex2.graphics.DrawArea areaBackbase1;

	@OriginalMember(owner = "client!client", name = "dd", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea areaBackbase2;

	@OriginalMember(owner = "client!client", name = "ed", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea areaBackhmid1;
	...
	private linkablelist spawnedLocations = new linkablelist();
	...
	private jagex2.graphics.Image24[] imageHeadicons = new jagex2.graphics.Image24[20];
	...
	private jagex2.graphics.Image24 genderButtonImage0;

	@OriginalMember(owner = "client!client", name = "jf", descriptor = "Lclient!hb;")
	private jagex2.graphics.Image24 genderButtonImage1;
	...
	private jagex2.graphics.Image24 imageFlamesLeft;

	@OriginalMember(owner = "client!client", name = "Af", descriptor = "Lclient!hb;")
	private jagex2.graphics.Image24 imageFlamesRight;
	...
	private jagex2.graphics.Image24 imageMapflag;
	...
	private jagex2.graphics.DrawArea imageTitle2;

	@OriginalMember(owner = "client!client", name = "zg", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea imageTitle3;

	@OriginalMember(owner = "client!client", name = "Ag", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea imageTitle4;

	@OriginalMember(owner = "client!client", name = "Bg", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea imageTitle0;

	@OriginalMember(owner = "client!client", name = "Cg", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea imageTitle1;

	@OriginalMember(owner = "client!client", name = "Dg", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea imageTitle5;

	@OriginalMember(owner = "client!client", name = "Eg", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea imageTitle6;

	@OriginalMember(owner = "client!client", name = "Fg", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea imageTitle7;

	@OriginalMember(owner = "client!client", name = "Gg", descriptor = "Lclient!qb;")
	private jagex2.graphics.DrawArea imageTitle8;
	...
	private jagex2.graphics.Image24 imageMinimap;
	...
	private jagex2.graphics.Image24[] imageCrosses = new jagex2.graphics.Image24[8];
	...
	private jagex2.graphics.Image24[] imageMapfunction = new jagex2.graphics.Image24[50];
	...
	private jagex2.graphics.Image24 imageCompass;
	...
	private linkablelist[][][] levelObjStacks = new linkablelist[4][104][104];
	...
	private void readZonePacket(@OriginalArg(1) packet arg1, @OriginalArg(2) int arg2) {
		...
		@Pc(110) int local110;
		@Pc(112) int local112;
		if (arg2 == zoneprot.LOC_ADD || arg2 == zoneprot.LOC_DEL) {
			local15 = arg1.g1();
		...
		} else if (arg2 == zoneprot.LOC_ANIM) {
			local15 = arg1.g1();
			local24 = this.baseX + (local15 >> 4 & 0x7);
			local31 = this.baseZ + (local15 & 0x7);
			local34 = arg1.g1();
			...
			if (arg2 == zoneprot.OBJ_REVEAL) {
				...
				if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
					...
					if (this.levelObjStacks[this.currentLevel][local24][local31] == null) {
						this.levelObjStacks[this.currentLevel][local24][local31] = new linkablelist();
					}
					this.levelObjStacks[this.currentLevel][local24][local31].pushBack(local395);
					this.sortObjStacks(local24, local31);
				}
			} else if (arg2 == zoneprot.OBJ_DEL) {
				local15 = arg1.g1();
				local24 = this.baseX + (local15 >> 4 & 0x7);
				local31 = this.baseZ + (local15 & 0x7);
				local34 = arg1.g2();
				if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
					@Pc(485) linkablelist local485 = this.levelObjStacks[this.currentLevel][local24][local31];
					if (local485 != null) {
				...
				if (arg2 == zoneprot.MAP_PROJANIM) {
					...
					if (arg2 == zoneprot.LOC_ADD_CHANGE) {
						local15 = arg1.g1();
						local24 = this.baseX + (local15 >> 4 & 0x7);
						local31 = this.baseZ + (local15 & 0x7);
						local34 = arg1.g1();
					...
					if (arg2 == zoneprot.OBJ_COUNT) {
						...
						local42 = arg1.g2();
						if (local24 >= 0 && local31 >= 0 && local24 < 104 && local31 < 104) {
							@Pc(1178) linkablelist local1178 = this.levelObjStacks[this.currentLevel][local24][local31];
							if (local1178 != null) {
	...
	private void drawScene() {
		...
		if (!this.cutscene) {
			...
			if (drawSceneCounter > 1802) {
				drawSceneCounter = 0;
				this.out.p1isaac(clientprot.ANTICHEAT_DRAW);
				this.out.p1(0);
		...
		Draw2D.clear();
		this.scene.draw(this.cameraYaw, this.cameraX, local34, this.cameraPitch, this.cameraY, this.cameraZ, loopCycle);
			...
			if (local30 != null && local30.isVisible()) {
				...
				if (local87 >= 0 && local87 < 104 && local92 >= 0 && local92 < 104) {
					if (local30.locModel == null || loopCycle < local30.locStartCycle || loopCycle >= local30.locStopCycle) {
						...
						this.scene.addTemporary(local30.z, 60, local30.seqDelay, local30.x, local35, local30.seqStretches, null, local30, local30.y, this.currentLevel);
					} else {
						local30.lowMemory = false;
						local30.y = this.getHeightmapY(this.currentLevel, local30.x, local30.z);
						this.scene.addTemporary(local30.maxTileX, null, local30.z, local30.y, local35, local30.seqDelay, local30.minTileZ, local30.minTileX, local30, this.currentLevel, local30.maxTileZ, local30.x);
					}
				}
			}
		}
					...
					if (this.showSocialInput) {
						...
						if ((local13 == 13 || local13 == 10) && this.chatTyped.length() > 0) {
							if (this.chatTyped.equals("::clientdrop")) {
								...
								jagex2.graphics.Image24.bilinearFiltering = false;
								Draw2D.fullViewport = false;
							} else if (this.chatTyped.equals("::qol")) {
								Draw3D.fixTransparency = true;
								jagex2.graphics.Image24.bilinearFiltering = true;
	...
	private void drawMinimap() {
		...
		for (@Pc(120) int local120 = 0; local120 < 104; local120++) {
			for (local124 = 0; local124 < 104; local124++) {
				@Pc(136) linkablelist local136 = this.levelObjStacks[this.currentLevel][local120][local124];
				if (local136 != null) {
	...
	private void updateTemporaryLocs() {
		...
		if (updateTemporaryLocsCounter > 85) {
			...
			this.out.p1isaac(clientprot.ANTICHEAT_UPDATE_LOCS);
		}
	}
	...
	private void loadTitleImages() {
		...
		this.imageFlamesLeft = new jagex2.graphics.Image24(128, 265);
		this.imageFlamesRight = new jagex2.graphics.Image24(128, 265);
		...
		for (@Pc(1) int local1 = 0; local1 < this.npcCount; local1++) {
			...
			if (local11 != null && local11.isVisible()) {
				...
				if (local31 >= 0 && local31 < 104 && local36 >= 0 && local36 < 104) {
					...
					this.scene.addTemporary(local11.z, (local11.size - 1) * 64 + 60, local11.seqDelay, local11.x, local20, local11.seqStretches, null, local11, this.getHeightmapY(this.currentLevel, local11.x, local11.z), this.currentLevel);
				}
			}
		}
	}
	...
	private void prepareGameScreen() {
		...
		this.areaChatback = new jagex2.graphics.DrawArea(this.context, 479, 96);
		this.areaMapback = new jagex2.graphics.DrawArea(this.context, 168, 160);
		Draw2D.clear();
		this.imageMapback.draw(0, 0);
		this.areaSidebar = new jagex2.graphics.DrawArea(this.context, 190, 261);
		this.areaViewport = new jagex2.graphics.DrawArea(this.context, 512, 334);
		Draw2D.clear();
		this.areaBackbase1 = new jagex2.graphics.DrawArea(this.context, 501, 61);
		this.areaBackbase2 = new jagex2.graphics.DrawArea(this.context, 288, 40);
		this.areaBackhmid1 = new jagex2.graphics.DrawArea(this.context, 269, 66);
			...
			if (local84.type == 0) {
				...
				if (local84.type == 2) {
						...
						for (local171 = 0; local171 < local84.width; local171++) {
							...
							if (local84.inventorySlotObjId[local165] > 0) {
								...
								if (local182 >= -32 && local182 <= 512 && local191 >= -32 && local191 <= 334 || this.objDragArea != 0 && this.objDragSlot == local165) {
									@Pc(251) jagex2.graphics.Image24 local251 = objtype.getIcon(local224, 24638, local84.inventorySlotObjCount[local165]);
								...
								@Pc(398) jagex2.graphics.Image24 local398 = local84.inventorySlotImage[local165];
								if (local398 != null) {
					...
					if (local84.type == 4) {
						...
						@Pc(766) jagex2.graphics.Image24 local766;
						if (this.executeInterfaceScript(local84)) {
	...
	private void drawGame() {
		...
		if (this.redrawSideicons) {
			if (this.flashingTab != -1 && this.flashingTab == this.selectedTab) {
				this.flashingTab = -1;
				this.out.p1isaac(clientprot.IF_FLASHING_TAB);
	...
	private void useMenuOption(@OriginalArg(1) int arg1) {
		...
		if (local28 == 450 && this.interactWithLoc(clientprot.OPLOCU, local18, local23, local33)) {
		...
		if (local28 == 405 || local28 == 38 || local28 == 422 || local28 == 478 || local28 == 347) {
			if (local28 == 478) {
				...
				if (opHeld1Counter >= 90) {
					this.out.p1isaac(clientprot.ANTICHEAT_OPHELD4);
				}
			...
			if (local28 == 405) {
				...
				if (opHeld4Counter >= 97) {
					this.out.p1isaac(clientprot.ANTICHEAT_OPHELD1);
			...
			if (local345 != null) {
				...
				if (local28 == 6) {
					...
					if (opNpc3Counter >= 124) {
						this.out.p1isaac(clientprot.ANTICHEAT_OPNPC3);
						this.out.p4(0);
					}
				...
				if (local28 == 245) {
					...
					if (opNpc5Counter >= 85) {
						this.out.p1isaac(clientprot.ANTICHEAT_OPNPC5);
						this.out.p2(39596);
					}
		...
		if (local28 == 285) {
			this.interactWithLoc(clientprot.OPLOC1, local18, local23, local33);
		}
		if (local28 == 881) {
		...
		if (local28 == 188) {
				...
				if (local969 != null) {
					...
					if (local28 == 151) {
						...
						if (opPlayer2Counter >= 90) {
							this.out.p1isaac(clientprot.ANTICHEAT_OPPLAYER2);
							this.out.p2(31114);
						}
			...
			if (local28 == 55 && this.interactWithLoc(clientprot.OPLOCT, local18, local23, local33)) {
				this.out.p2(this.activeSpellId);
			}
			...
			if (local28 == 504) {
				this.interactWithLoc(clientprot.OPLOC2, local18, local23, local33);
			}
			...
			if (local28 == 930) {
				...
				if (local28 == 602 || local28 == 596 || local28 == 22 || local28 == 892 || local28 == 415) {
					if (local28 == 22) {
						this.out.p1isaac(clientprot.IF_BUTTON3);
					}
					if (local28 == 415) {
						if ((local23 & 0x3) == 0) {
							ifButton5Counter++;
						...
						if (ifButton5Counter >= 55) {
							this.out.p1isaac(clientprot.ANTICHEAT_IF_BUTTON5);
							this.out.p4(0);
						}
						this.out.p1isaac(clientprot.IF_BUTTON5);
					}
					if (local28 == 602) {
						this.out.p1isaac(clientprot.IF_BUTTON1);
					}
					if (local28 == 892) {
						if ((local18 & 0x3) == 0) {
							opHeld9Counter++;
						...
						if (opHeld9Counter >= 130) {
							this.out.p1isaac(clientprot.ANTICHEAT_IF_BUTTON4);
							this.out.p1(177);
						}
						this.out.p1isaac(clientprot.IF_BUTTON4);
					}
					if (local28 == 596) {
						this.out.p1isaac(clientprot.IF_BUTTON2);
					}
					this.out.p2(local33);
					this.out.p2(local18);
					this.out.p2(local23);
				...
				if (local28 == 581) {
					...
					if (opLoc4Counter >= 99) {
						this.out.p1isaac(clientprot.ANTICHEAT_OPLOC4);
						this.out.p4(0);
					}
					this.interactWithLoc(clientprot.OPLOC4, local18, local23, local33);
				}
				if (local28 == 965) {
					local500 = this.tryMove(this.localPlayer.pathTileX[0], 0, false, local18, this.localPlayer.pathTileZ[0], 0, 2, 0, local23, 0, 0, 0);
					if (!local500) {
				...
				if (local28 == 1501) {
					...
					if (opLoc5Counter >= 92) {
						this.out.p1isaac(clientprot.ANTICHEAT_OPLOC5);
						this.out.p4(0);
					}
					this.interactWithLoc(clientprot.OPLOC5, local18, local23, local33);
				}
				if (local28 == 364) {
					this.interactWithLoc(clientprot.OPLOC3, local18, local23, local33);
				}
				if (local28 == 1102) {
					local830 = objtype.get(local33);
	...
	private boolean handleInterfaceAction(@OriginalArg(1) iftype arg1) {
		...
		if (local4 == 326) {
			this.out.p1isaac(clientprot.IF_DESIGN);
	...
	protected void load() {
		...
		try {
			...
			this.imageCompass = new jagex2.graphics.Image24(local277, "compass", 0);
			timeStart("mapscene");
			@Pc(450) int local450;
			try {
			...
			try {
				for (local450 = 0; local450 < 50; local450++) {
					this.imageMapfunction[local450] = new jagex2.graphics.Image24(local277, "mapfunction", local450);
				}
			...
			try {
				for (local450 = 0; local450 < 20; local450++) {
					this.imageHitmarks[local450] = new jagex2.graphics.Image24(local277, "hitmarks", local450);
				}
			...
			try {
				for (local450 = 0; local450 < 8; local450++) {
					this.imageHeadicons[local450] = new jagex2.graphics.Image24(local277, "headicons", local450);
				}
			} catch (@Pc(528) Exception local528) {
			}
			timeEnd("headicons");
			this.imageMapflag = new jagex2.graphics.Image24(local277, "mapflag", 0);
			timeStart("crosses");
			for (local450 = 0; local450 < 8; local450++) {
				this.imageCrosses[local450] = new jagex2.graphics.Image24(local277, "cross", local450);
			}
			timeEnd("crosses");
			this.imageMapdot0 = new jagex2.graphics.Image24(local277, "mapdots", 0);
			this.imageMapdot1 = new jagex2.graphics.Image24(local277, "mapdots", 1);
			this.imageMapdot2 = new jagex2.graphics.Image24(local277, "mapdots", 2);
			this.imageMapdot3 = new jagex2.graphics.Image24(local277, "mapdots", 3);
			...
			@Pc(725) jagex2.graphics.Image24 local725 = new jagex2.graphics.Image24(local277, "backleft1", 0);
			this.areaBackleft1 = new jagex2.graphics.DrawArea(this.context, local725.width, local725.height);
			local725.blitOpaque(0, 0);
			@Pc(750) jagex2.graphics.Image24 local750 = new jagex2.graphics.Image24(local277, "backleft2", 0);
			this.areaBackleft2 = new jagex2.graphics.DrawArea(this.context, local750.width, local750.height);
			local750.blitOpaque(0, 0);
			@Pc(775) jagex2.graphics.Image24 local775 = new jagex2.graphics.Image24(local277, "backright1", 0);
			this.areaBackright1 = new jagex2.graphics.DrawArea(this.context, local775.width, local775.height);
			local775.blitOpaque(0, 0);
			@Pc(800) jagex2.graphics.Image24 local800 = new jagex2.graphics.Image24(local277, "backright2", 0);
			this.areaBackright2 = new jagex2.graphics.DrawArea(this.context, local800.width, local800.height);
			local800.blitOpaque(0, 0);
			@Pc(825) jagex2.graphics.Image24 local825 = new jagex2.graphics.Image24(local277, "backtop1", 0);
			this.areaBacktop1 = new jagex2.graphics.DrawArea(this.context, local825.width, local825.height);
			local825.blitOpaque(0, 0);
			@Pc(850) jagex2.graphics.Image24 local850 = new jagex2.graphics.Image24(local277, "backtop2", 0);
			this.areaBacktop2 = new jagex2.graphics.DrawArea(this.context, local850.width, local850.height);
			local850.blitOpaque(0, 0);
			@Pc(875) jagex2.graphics.Image24 local875 = new jagex2.graphics.Image24(local277, "backvmid1", 0);
			this.areaBackvmid1 = new jagex2.graphics.DrawArea(this.context, local875.width, local875.height);
			local875.blitOpaque(0, 0);
			@Pc(900) jagex2.graphics.Image24 local900 = new jagex2.graphics.Image24(local277, "backvmid2", 0);
			this.areaBackvmid2 = new jagex2.graphics.DrawArea(this.context, local900.width, local900.height);
			local900.blitOpaque(0, 0);
			@Pc(925) jagex2.graphics.Image24 local925 = new jagex2.graphics.Image24(local277, "backvmid3", 0);
			this.areaBackvmid3 = new jagex2.graphics.DrawArea(this.context, local925.width, local925.height);
			local925.blitOpaque(0, 0);
			@Pc(950) jagex2.graphics.Image24 local950 = new jagex2.graphics.Image24(local277, "backhmid2", 0);
			this.areaBackhmid2 = new jagex2.graphics.DrawArea(this.context, local950.width, local950.height);
			...
			this.imageMinimap = new jagex2.graphics.Image24(512, 512);
	...
	private void drawOnMinimap(@OriginalArg(0) int arg0, @OriginalArg(2) jagex2.graphics.Image24 arg2, @OriginalArg(3) int arg3) {
	...
	private void loadTitle() {
		...
		this.imageTitle0 = new jagex2.graphics.DrawArea(this.context, 128, 265);
		Draw2D.clear();
		this.imageTitle1 = new jagex2.graphics.DrawArea(this.context, 128, 265);
		Draw2D.clear();
		this.imageTitle2 = new jagex2.graphics.DrawArea(this.context, 533, 186);
		Draw2D.clear();
		this.imageTitle3 = new jagex2.graphics.DrawArea(this.context, 360, 146);
		Draw2D.clear();
		this.imageTitle4 = new jagex2.graphics.DrawArea(this.context, 360, 200);
		Draw2D.clear();
		this.imageTitle5 = new jagex2.graphics.DrawArea(this.context, 214, 267);
		Draw2D.clear();
		this.imageTitle6 = new jagex2.graphics.DrawArea(this.context, 215, 267);
		Draw2D.clear();
		this.imageTitle7 = new jagex2.graphics.DrawArea(this.context, 86, 79);
		Draw2D.clear();
		this.imageTitle8 = new jagex2.graphics.DrawArea(this.context, 87, 79);
		Draw2D.clear();
	...
	private void login(@OriginalArg(0) String arg0, @OriginalArg(1) String arg1, @OriginalArg(2) boolean arg2) {
		...
		try {
			...
			if (local237 == 2 || local237 == 18) {
				...
				this.spawnedLocations = new linkablelist();
				this.friendCount = 0;
	...
	private void updateGame() {
		...
		if (this.ingame) {
				...
				if (super.mouseButton == 0) {
					...
					if (this.objGrabThreshold && this.objDragCycles >= 5) {
						...
						if (this.hoveredSlotParentId == this.objDragInterfaceId && this.hoveredSlot != this.objDragSlot) {
							...
							this.out.p1isaac(clientprot.IF_BUTTOND);
			...
			if (updateGame > 127) {
				updateGame = 0;
				this.out.p1isaac(clientprot.ANTICHEAT_UPDATE);
				this.out.p3(4991788);
			}
			...
			if (updateGameCounter2 > 110) {
				...
				this.out.p1isaac(clientprot.ANTICHEAT_UPDATE2);
				this.out.p4(0);
			}
			this.heartbeatTimer++;
		...
		for (@Pc(13) SpotAnimEntity local13 = (SpotAnimEntity) this.spotanims.peekFront(); local13 != null; local13 = (SpotAnimEntity) this.spotanims.prev()) {
			if (local13.level != this.currentLevel || local13.seqComplete) {
				...
				if (local13.seqComplete) {
					...
					this.scene.addTemporary(local13.z, 60, 0, local13.x, -1, false, null, local13, local13.y, local13.level);
				}
			}
		}
	}
	...
	private void handleTabInput() {
		...
		if (handleTabInputCounter > 150) {
			...
			this.out.p1isaac(clientprot.ANTICHEAT_SIDEBAR_INPUT);
			this.out.p1(43);
		}
	}
	...
	private void sortObjStacks(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		@Pc(9) linkablelist local9 = this.levelObjStacks[this.currentLevel][arg0][arg1];
		if (local9 == null) {
		...
		this.scene.addObjStack(local148.getInterfaceModel(local23.count), local118, this.getHeightmapY(this.currentLevel, arg0 * 128 + 64, arg1 * 128 + 64), this.currentLevel, local144, arg1, arg0, local128);
	}
	...
	private void buildScene() {
		try {
			...
			System.gc();
			@Pc(53) SceneBuilder local53 = new SceneBuilder(104, this.levelTileFlags, 104, this.levelHeightmap);
	...
	private void loadTitleBackground() {
		...
		@Pc(14) jagex2.graphics.Image24 local14 = new jagex2.graphics.Image24(local8, this.context);
	...
	private void handleViewportOptions() {
		...
		for (@Pc(52) int local52 = 0; local52 < Model.pickedCount; local52++) {
			...
			if (local58 != local41) {
				...
				if (local74 == 3) {
					@Pc(565) linkablelist local565 = this.levelObjStacks[this.currentLevel][local62][local68];
					if (local565 != null) {
	...
	private void updatePlayers() {
		...
		if (updatePlayersCounter > 1406) {
			...
			this.out.p1isaac(clientprot.ANTICHEAT_UPDATE_PLAYERS);
			this.out.p1(0);
	...
	private boolean read() {
		...
		try {
			...
			@Pc(650) int local650;
			if (this.packetType == serverprot.LOAD_AREA) {
				local159 = this.in.g2();
				local462 = this.in.g2();
				...
				this.out.p1isaac(clientprot.MAP_REQUEST_AREAS);
				this.out.p1(0);
				local466 = 0;
				@Pc(662) int local662;
			...
			if (this.packetType == serverprot.CLEAR_WALKING_QUEUE) {
				this.flagSceneTileX = 0;
				this.packetType = -1;
				return true;
			}
			...
			if (this.packetType == serverprot.IF_OPENSUB) {
				local159 = this.in.g2();
				local462 = this.in.g2();
				if (this.chatInterfaceId != -1) {
					this.chatInterfaceId = -1;
			...
			if (this.packetType == serverprot.IF_SETTAB) {
				local159 = this.in.g2();
				local462 = this.in.g1();
				if (local159 == 65535) {
					local159 = -1;
			...
			if (this.packetType == serverprot.IF_IAMOUNT) {
				this.showSocialInput = false;
			...
			if (this.packetType == serverprot.UPDATE_INV_CLEAR) {
				local159 = this.in.g2();
				local1745 = iftype.instances[local159];
			...
			if (this.packetType == serverprot.IF_SETTAB_FLASH) {
			...
			if (this.packetType == serverprot.IF_MULTIZONE) {
			...
			if (this.packetType == serverprot.IF_SETMODEL_COLOUR) {
				local159 = this.in.g2();
				local462 = this.in.g2();
				local211 = this.in.g2();
			...
			if (this.packetType == serverprot.IF_OPENSIDEBAR) {
				local159 = this.in.g2();
			...
			if (this.packetType == serverprot.IF_OPENBOTTOM) {
				local159 = this.in.g2();
				this.resetInterfaceAnimation(local159);
				if (this.sidebarInterfaceId != -1) {
					this.sidebarInterfaceId = -1;
			...
			if (this.packetType == serverprot.CAM_FORCEANGLE) {
				this.cutscene = true;
			...
			if (this.packetType == serverprot.IF_OPENSTICKY) {
			...
			if (this.packetType == serverprot.IF_SETTAB_ACTIVE) {
			...
			if (this.packetType == serverprot.IF_OPENTOP) {
				local159 = this.in.g2();
				this.resetInterfaceAnimation(local159);
				if (this.sidebarInterfaceId != -1) {
					this.sidebarInterfaceId = -1;
			...
			if (this.packetType == serverprot.IF_CLOSESUB) {
				if (this.sidebarInterfaceId != -1) {
					this.sidebarInterfaceId = -1;
					this.redrawSidebar = true;
					this.redrawSideicons = true;
