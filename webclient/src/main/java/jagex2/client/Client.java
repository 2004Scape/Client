...
public final class Client extends GameShell {
	...
	private void prepareGameScreen() {
		...
		this.areaChatback = new PixMap(this.context, 479, 96);
		this.areaMapback = new PixMap(this.context, 168, 160);
		Draw2D.clear();
		this.imageMapback.draw(0, 0);
		this.areaSidebar = new PixMap(this.context, 190, 261);
		this.areaViewport = new PixMap(this.context, 512, 334);
		Draw2D.clear();
		this.areaBackbase1 = new PixMap(this.context, 501, 61);
		this.areaBackbase2 = new PixMap(this.context, 288, 40);
		this.areaBackhmid1 = new PixMap(this.context, 269, 66);
	...
	protected void load() {
		...
		try {
			...
			this.areaBackleft1 = new PixMap(this.context, local725.width, local725.height);
			local725.blitOpaque(0, 0);
			@Pc(750) Pix24 local750 = new Pix24(local277, "backleft2", 0);
			this.areaBackleft2 = new PixMap(this.context, local750.width, local750.height);
			local750.blitOpaque(0, 0);
			@Pc(775) Pix24 local775 = new Pix24(local277, "backright1", 0);
			this.areaBackright1 = new PixMap(this.context, local775.width, local775.height);
			local775.blitOpaque(0, 0);
			@Pc(800) Pix24 local800 = new Pix24(local277, "backright2", 0);
			this.areaBackright2 = new PixMap(this.context, local800.width, local800.height);
			local800.blitOpaque(0, 0);
			@Pc(825) Pix24 local825 = new Pix24(local277, "backtop1", 0);
			this.areaBacktop1 = new PixMap(this.context, local825.width, local825.height);
			local825.blitOpaque(0, 0);
			@Pc(850) Pix24 local850 = new Pix24(local277, "backtop2", 0);
			this.areaBacktop2 = new PixMap(this.context, local850.width, local850.height);
			local850.blitOpaque(0, 0);
			@Pc(875) Pix24 local875 = new Pix24(local277, "backvmid1", 0);
			this.areaBackvmid1 = new PixMap(this.context, local875.width, local875.height);
			local875.blitOpaque(0, 0);
			@Pc(900) Pix24 local900 = new Pix24(local277, "backvmid2", 0);
			this.areaBackvmid2 = new PixMap(this.context, local900.width, local900.height);
			local900.blitOpaque(0, 0);
			@Pc(925) Pix24 local925 = new Pix24(local277, "backvmid3", 0);
			this.areaBackvmid3 = new PixMap(this.context, local925.width, local925.height);
			local925.blitOpaque(0, 0);
			@Pc(950) Pix24 local950 = new Pix24(local277, "backhmid2", 0);
			this.areaBackhmid2 = new PixMap(this.context, local950.width, local950.height);
	...
	private void loadTitle() {
		...
		this.imageTitle0 = new PixMap(this.context, 128, 265);
		Draw2D.clear();
		this.imageTitle1 = new PixMap(this.context, 128, 265);
		Draw2D.clear();
		this.imageTitle2 = new PixMap(this.context, 533, 186);
		Draw2D.clear();
		this.imageTitle3 = new PixMap(this.context, 360, 146);
		Draw2D.clear();
		this.imageTitle4 = new PixMap(this.context, 360, 200);
		Draw2D.clear();
		this.imageTitle5 = new PixMap(this.context, 214, 267);
		Draw2D.clear();
		this.imageTitle6 = new PixMap(this.context, 215, 267);
		Draw2D.clear();
		this.imageTitle7 = new PixMap(this.context, 86, 79);
		Draw2D.clear();
		this.imageTitle8 = new PixMap(this.context, 87, 79);
		Draw2D.clear();
