...
public final class Pix24 extends Draw2D {
	...
	public void method64() {
		Draw2D.method87(this.anIntArray7, this.anInt55, this.anInt56);
	}
	...
	public void method65(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		arg0 += this.anInt57;
		arg1 += this.anInt58;
		@Pc(15) int local15 = arg0 + arg1 * Draw2D.anInt78;
		@Pc(17) int local17 = 0;
		@Pc(20) int local20 = this.anInt56;
		@Pc(23) int local23 = this.anInt55;
		@Pc(27) int local27 = Draw2D.anInt78 - local23;
		@Pc(29) int local29 = 0;
		@Pc(36) int local36;
		if (arg1 < Draw2D.anInt80) {
			local36 = Draw2D.anInt80 - arg1;
			local20 -= local36;
			arg1 = Draw2D.anInt80;
			local17 += local36 * local23;
			local15 += local36 * Draw2D.anInt78;
		}
		if (arg1 + local20 > Draw2D.anInt81) {
			local20 -= arg1 + local20 - Draw2D.anInt81;
		}
		if (arg0 < Draw2D.anInt82) {
			local36 = Draw2D.anInt82 - arg0;
			local23 -= local36;
			arg0 = Draw2D.anInt82;
			local17 += local36;
			local15 += local36;
		...
		if (arg0 + local23 > Draw2D.anInt83) {
			local36 = arg0 + local23 - Draw2D.anInt83;
			local23 -= local36;
			local29 += local36;
			local27 += local36;
		}
		if (local23 > 0 && local20 > 0) {
			this.method66(Draw2D.anIntArray10, this.anIntArray7, 0, local17, local15, local23, local20, local27, local29);
		}
	}
	...
	public void method67(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1) {
		...
		if (local23 > 0 && local20 > 0) {
			this.method68(Draw2D.anIntArray10, this.anIntArray7, local17, local15, local23, local20, local27, local29);
		}
	}
