...
public final class WorldmapFont extends Draw2D {
	...
	public WorldmapFont(@OriginalArg(0) int arg0, @OriginalArg(1) boolean arg1, @OriginalArg(2) GameShell arg2) {
		...
		for (local36 = 0; local36 < 95; local36++) {
			this.method31(local30, local34, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(local36), local36, false, arg2);
		}
		if (arg1 && this.aBoolean5) {
			this.anInt46 = 855;
			this.aBoolean5 = false;
			...
			if (!this.aBoolean5) {
				...
				this.aBoolean5 = false;
				for (local36 = 0; local36 < 95; local36++) {
					this.method31(local30, local34, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"£$%^&*()-_=+[{]};:'@#~,<.>/?\\| ".charAt(local36), local36, true, arg2);
				}
			}
		}
		@Pc(123) byte[] local123 = new byte[this.anInt46];
		for (@Pc(125) int local125 = 0; local125 < this.anInt46; local125++) {
	...
	private void method31(@OriginalArg(0) Font arg0, @OriginalArg(1) FontMetrics arg1, @OriginalArg(2) char arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4, @OriginalArg(5) GameShell arg5) {
		...
		this.aByteArray1[arg3 * 9] = (byte) (this.anInt46 / 16384);
		this.aByteArray1[arg3 * 9 + 1] = (byte) (this.anInt46 / 128 & 0x7F);
		this.aByteArray1[arg3 * 9 + 2] = (byte) (this.anInt46 & 0x7F);
		...
		for (local145 = local139; local145 < local143; local145++) {
			for (local149 = local137; local149 < local141; local149++) {
				...
				this.aByteArray1[this.anInt46++] = (byte) local159;
			}
		}
	}

	@OriginalMember(owner = "mapview!f", name = "a", descriptor = "(Ljava/lang/String;IIIZ)V")
	private void method32(@OriginalArg(0) String arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) boolean arg4) {
		try {
			if (this.aBoolean5 || arg3 == 0) {
				arg4 = false;
			}
			for (@Pc(8) int local8 = 0; local8 < arg0.length(); local8++) {
				@Pc(16) int local16 = anIntArray5[arg0.charAt(local8)];
				if (arg4) {
					this.method37(local16, arg1 + 1, arg2, 0, this.aByteArray1, this.aBoolean5);
					this.method37(local16, arg1, arg2 + 1, 0, this.aByteArray1, this.aBoolean5);
				}
				this.method37(local16, arg1, arg2, arg3, this.aByteArray1, this.aBoolean5);
	...
	private void method34(@OriginalArg(0) int[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
	...
	private int method36(@OriginalArg(0) String arg0) {
		@Pc(3) int local3 = 0;
	...
	private void method37(@OriginalArg(0) int arg0, @OriginalArg(1) int arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) byte[] arg4, @OriginalArg(5) boolean arg5) {
	...
	private void method38(@OriginalArg(0) int[] arg0, @OriginalArg(1) byte[] arg1, @OriginalArg(2) int arg2, @OriginalArg(3) int arg3, @OriginalArg(4) int arg4, @OriginalArg(5) int arg5, @OriginalArg(6) int arg6, @OriginalArg(7) int arg7, @OriginalArg(8) int arg8) {
		try {
