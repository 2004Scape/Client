package com.jagex.game.runetek3.tea.config;
...
public final class IfType {
	...
	public static void unpack(@OriginalArg(0) FileArchive arg0, @OriginalArg(1) BitmapFont[] arg1, @OriginalArg(3) FileArchive arg3) {
		imageCache = new Cache(50000);
		modelCache = new Cache(50000);
		@Pc(27) Buffer buf = new Buffer(arg3.read("data", null));
		@Pc(29) int local29 = -1;
	...
	private static Image24 getImage(@OriginalArg(0) FileArchive arg0, @OriginalArg(1) int arg1, @OriginalArg(2) String arg2) {
		@Pc(8) long local8 = (StringUtils.hashCode(arg2) << 8) + (long) arg1;
